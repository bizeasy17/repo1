...
<div id="wpsp_show_more">
    ...
    if($arrayVisible['raisedby'] && current_user_can( 'manage_options' )&& $FrontEndDisplaySettings['wpsp_ChangeRaisedBy']){
        ...
        ?>
        <button style="<?php echo $btnStyle;?>" class="btn btn-primary wpsp_ticket_nav_btn" onclick="getRaisedByTicketUser(<?php echo $ticket_id;?>);"><?php printf(__('%s','wp-support-plus-responsive-ticket-system'),$FrontEndDisplaySettings['front_end_display_alice'][13]);?></button><?php
        }
    else{
        foreach($advancedSettings['modify_raised_by'] as $modifyRaisedBy){
            ...
            $btnStyle="color:".$FrontEndDisplaySettings['wpsp_cb_fc']."; background-color:".$FrontEndDisplaySettings['wpsp_cb_bc']."; border-color:".$FrontEndDisplaySettings['wpsp_cb_bc'];
        ?>
        <button style="<?php echo $btnStyle;?>" class="btn btn-primary wpsp_ticket_nav_btn" onclick="getRaisedByTicketUser(<?php echo $ticket_id;?>);"><?php printf(__('%s','wp-support-plus-responsive-ticket-system'),$FrontEndDisplaySettings['front_end_display_alice'][13]);?></button>
    <?php   }
        }   
    }?>
